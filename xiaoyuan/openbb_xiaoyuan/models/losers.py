"""XiaoYuan Asset Performance Losers Model."""
...
class XiaoYuanLosersQueryParams(EquityPerformanceQueryParams):
    """XiaoYuan Asset Performance Losers Query.

    Source: https://finance.yahoo.com/screener/predefined/day_Losers
    """


class XiaoYuanLosersData(EquityPerformanceData):
    """XiaoYuan Asset Performance Losers Data."""
...
class XiaoYuanLosersFetcher(
    Fetcher[XiaoYuanLosersQueryParams, List[XiaoYuanLosersData]]
):
    """Transform the query, extract and transform the data from the XiaoYuan endpoints."""

    @staticmethod
    def transform_query(params: Dict[str, Any]) -> XiaoYuanLosersQueryParams:
        """Transform query params."""
        return XiaoYuanLosersQueryParams(**params)

    @staticmethod
    def extract_data(
        query: XiaoYuanLosersQueryParams,
        ...
        **kwargs: Any,
        ...
        sc = f"""
            ...
            t = select * from t where percent_change > -0.025 and 收盘价（不复权） >= 5.0 and 成交量（不复权） > 20000 and 总市值 > 1000000000
    ...
    def transform_data(
        ...
        **kwargs: Any,
        ...
        if query.sort == "desc":
            ...
            ascending = True
        return [
            XiaoYuanLosersData.model_validate(d)
